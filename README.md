...
| <a name="create_private_nat_gateway_route"></a> [create\_private\_nat\_gateway\_route](#input\_create\_private\_nat\_gateway\_route) | Controls if a NAT gateway route for private subnet routing table should be created | `bool` | `true` | no |
